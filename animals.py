...
class Dog(Animal):
    ...
    @commands.setter
    def commands(self, command: tuple(str, list)):
...
if __name__ == '__main__':
    fish = Fish(True, "Charly", "Navy seal")
    cat = Cat(False, "Barsik", "Munchkin")
    dog = Dog("Oskar", "Newfoundland")
    dog.commands = ["голос", "апорт"]
    fish.get_unic_attr()
    cat.get_unic_attr()
    dog.get_unic_attr()